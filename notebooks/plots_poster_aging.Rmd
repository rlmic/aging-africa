...
```{r prie, fig.cap="Employment. Age Group and Gender.", echo=FALSE, fig.height=35, fig.width=40, dev = c("png", "tiff"), dpi=50}

fac_row_popu_his( theme_top()) + labs(y = "Population\n(Count)")
