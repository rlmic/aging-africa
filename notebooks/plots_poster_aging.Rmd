...
ssa_agg = melt(ssa_agg,
    ...
    id.vars=c("gender", "age_group5"),
        # The source columns
    measure.vars=c("married", "depressed", "healthinsurance_ever", "ill_inj",  "ill_inj_stopactivity", "urban", "lives_alone", "work_any", "notmarried"),
...
fac_row_agg <- function(
  ...
  condition.labs <- c("Living Arrangements \nMarried \n (Proportion)", "Physocological Health \n (Depression)", "Health\nInsurance\n(Proportion)", "Health\nIllness/Injury\n(Proportion)", "Health\nStopped\nActivities\n(Proportion)", "Urban Status\n(Proportion)", "Living Arrangements\nLives alone\n(Proportion)", "Employment\n(Proportion)", "Living Arrangements \nUnmarried \n (Proportion)")
  names(condition.labs) <- c("married", "depressed", "healthinsurance_ever", "ill_inj",  "ill_inj_stopactivity", "urban", "lives_alone", "work_any", "notmarried")
  graph <- ssa_agg %>% 
...
```{r meas_agg, fig.cap="Employment. Age Group and Gender. (Agg)", echo=FALSE, fig.height=35, fig.width=15, dev = c("png", "tiff"), dpi=400}
breaks=c("20","25","30", "35", "40", "45", "50", "55", "60", "65", "70", "75", "80")
