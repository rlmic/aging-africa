...
# Main pipeline
totpop <- pop_pro %>%
  select(countryregion, pop_total_1990, pop_total_2020, pop_total_2050, pop_total_2100) %>%
...
# Plot 1a
fig1a <- ggplot(totpop, aes(condition, measurement, fill = countryregion, label = countryregion)) +
...
# Plot 1b
fig1b <- ggplot(over60, aes(condition, measurement, fill = countryregion, label = countryregion)) +
  geom_area(type = "ridge", bw = 1) +
