...
outcomes_weighted = trans_input(ssa_agg, measures)  
outcomes_nonweight = trans_input(ssa_agg_non, measures)  

disabili_weighted = trans_input(ssa_agg, limitations)  
disabili_nonweight = trans_input(ssa_agg_non, limitations)  
...
```{r outcomes_aggregate_nonweighted, fig.cap="Employment. Age Group and Gender.", echo=FALSE, fig.height=10, fig.width=30, dev = c("png", "tiff"), dpi=200}
fac_row_agg(
  outcomes_nonweight,
  measures,
  measures_labs,
...
```{r outcomes_aggregate_weighted, fig.cap="Employment. Age Group and Gender.", echo=FALSE, fig.height=40, fig.width=15, dev = c("png", "tiff"), dpi=200}
fac_row_agg(
  outcomes_weighted,
  measures,
  measures_labs,
...
```{r disabilities_aggregate_nonweighted, fig.cap="Functional Limitations.", fig.height=40, fig.width=15, dev=c("png", "tiff"), dpi=200, include=FALSE}
fac_row_agg(
  disabili_nonweight,
  limitations,
  limitations_labs,
...
```{r disabilities_aggregate_weighted, fig.cap="Functional Limitations.", fig.height=40, fig.width=15, dev=c("png", "tiff"), dpi=200, include=FALSE}
fac_row_agg(
  disabili_weighted,
  limitations,
  limitations_labs,
...
```{r disability, fig.cap="Functional Limitations by Age Group and Gender.", echo=FALSE, fig.height=35, fig.width=45, dev = c("png", "tiff"), dpi=400}
