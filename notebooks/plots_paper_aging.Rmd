...
b <- fac_row("diff_seei", theme_top(), weighted=FALSE) + 
  ylim(0, 1) + 
  labs(y = "Seeing", x = "Age") + 
  scale_x_discrete(
      breaks=bre_age,
...
f <- fac_row("diff_self_care", theme_middle(), weighted=FALSE ) + ylim(0, 1) + labs(y = "With Self Care", x = "Age")+ scale_x_discrete(
      breaks=bre_age,
      labels=lab_age,
      position="bottom"
      )+  theme(legend.position = "none")

i <- fac_row("diff_comm", theme_bottom(),  weighted=FALSE) + ylim(0, 1) + labs(y = "Communication", x = "Age")+ scale_x_discrete(
      breaks=bre_age,
      labels=lab_age,
      position="bottom"
      )
