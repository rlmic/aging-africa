...
fac_row_agg_count_out <- function(
  ...
  graph <-data %>%  
    filter(condition!='healthinsurance_ever' & condition!='work_hrs' ) %>% 
...
dat_long %>% 
  ...
  geom_hline(
    ...
    aes(yintercept = value, color=" African Countries"),
    size=sz
    ) +
  geom_hline(
